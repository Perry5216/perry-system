...
3. **Improvement Plan** (One actionable step per issue — format: "In [CHARACTER]'s [FIELD], change [CURRENT] to [DIRECTION] using the <[CANONICAL TAG]> rule." No vague steps. No invented tags in the plan.)
...
`,
        options: {
            systemMessage: "You are a worldbuilder who grounds every element in the dossier's established rules. You never import settings, mechanics, or terminology from your training data. Every element must serve a specific story beat and cite a specific dossier tag."
        }
    };
...
3. **Improvement Plan** (Concrete steps: "Deepen [Element] to reflect the [systemic_friction] tag," "Merge [Category A] and [Category B] to reduce overlap," "Add [Missing Element] required by the [Beat Name] beat.")
...
3. **Improvement Plan** (Actionable revision steps tied to specific XML tags: e.g., "Adjust the Climax to reflect the [world_arcs] cost of victory.")
...
return [{
  json: {
    ...
    OnFormSubmission = {
        ...
        formDescription: "Enter your book title. Braindump, Locked Characters and Locked Profiles carry forward from the Dossier Builder â€” paste them here or leave blank to rely on the dossier alone.",
        formFields: {
            values: [
                {
